# Build the codex-fail-autoban plugin into a Windows .dll.
#
# Requirements:
#   - Go 1.21+ (this plugin vendors the CPA SDK contract locally under cpasdk/,
#     so it does NOT require the Go 1.26 that the full CLIProxyAPI module needs)
...
#         plugins/windows/amd64/codex-fail-autoban.dll
#   (CPA also accepts it directly under plugins/ . The plugin id is the file
#    name without the extension: "codex-fail-autoban".)

$ErrorActionPreference = "Stop"

$out = "codex-fail-autoban.dll"
